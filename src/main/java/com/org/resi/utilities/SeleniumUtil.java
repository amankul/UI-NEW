package com.org.resi.utilities;

import com.org.resi.constants.GlobalConstants;
...
public class SeleniumUtil {
    ...
    public WebDriver createBrowserStackDriver(String url, String browser, String browserVersion) {
        ...
        final String USERNAME = "vinodkumar51"; // TODO Update browser stack account user name & key
        final String AUTOMATE_KEY = "Rqsyg1JcyzyYQEx19Ew3";
        final String URL =
...
//    }
    ...
    public WebDriver createDriver(String url, String browser) {
        ...
        log.info("Created Web Driver, Navigated to url - " + url);
        return driver;
    }
    ...
    public FirefoxProfile firefoxProfile() {
        ...
        // Handling downloads - saving files to "downloads" folder present in the resi
        profile.setPreference("browser.download.folderList", 2);
        profile.setPreference("browser.download.manager.showWhenStarting", false);
        profile.setPreference(
                "browser.download.dir",
                System.getProperty("user.dir") + "/src/main/java/com/org/maas/downloads");
        profile.setPreference(
    ...
    public void hoverAndClick(WebDriver driver, By locator) {
        Actions action = new Actions(driver);
        action.moveToElement(wait_until_ElementIs_Clickable(driver, locator)).click().build().perform();
    ...
    public void hoverClickAndPressEnter(WebDriver driver, By locator) {
        Actions action = new Actions(driver);
        action
                .moveToElement(wait_until_ElementIs_Clickable(driver, locator))
                .click()
                .sendKeys(Keys.ENTER)
                .build()
                .perform();
    ...
    public void doubleClick(WebDriver driver, By locator) {
        ...
        doubleClick.doubleClick(wait_until_ElementIs_Clickable(driver, locator)).build().perform();
        waitForPageToLoad(driver);
    }
    ...
    public void jsFocusAndClick(WebDriver driver, By locator) {
        WebElement element = wait_until_ElementIs_Clickable(driver, locator);
